...
training_xml_path = os.path.join(whale_folder, "training.xml")
testing_xml_path = os.path.join(whale_folder, "testing.xml")
...
for f in glob.glob(os.path.join(whale_folder, "*.jpg")):
